            ...
            <div className='tableResult'>
                <div className="Performance">
                    <StyledProgress className='block' value={json.performance}>
                        <CircularProgressbar value={json.performance} maxValue={1} text={`${json.performance * 100}%`} />
                ...
                <div className="Accessibility">
                    <StyledProgress value={json.accessibility}>
                        <CircularProgressbar value={json.accessibility} maxValue={1} text={`${json.accessibility * 100}%`} />
                ...
                <div className="Best Practices">
                    <StyledProgress value={json.bestPractices}>
                        <CircularProgressbar value={json.bestPractices} maxValue={1} text={`${json.bestPractices * 100}%`} />
                        <p className='categoryName'>Best Practices</p>
                    </StyledProgress>
                </div>
                <div className="SEO">
                    <StyledProgress value={json.seo}>
                        <CircularProgressbar value={json.seo} maxValue={1} text={`${json.seo * 100}%`} />
                        <p className='categoryName'>SEO</p>
                    </StyledProgress>
                </div>
                <div className="Progressive Web App">
                    <StyledProgress value={json.progressiveWebApp}>
                        <CircularProgressbar value={json.progressiveWebApp} maxValue={1} text={`${json.progressiveWebApp * 100}%`} />
