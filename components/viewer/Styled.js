 ...
 */
 ...
 .lh-vars {
    ...
    --monospace-font-family: "Menlo", "dejavu sans mono", "Consolas",
  ...
  .lh-vars.lh-devtools {
    --text-font-family: ".SFNSDisplay-Regular", "Helvetica Neue", "Lucida Grande",
      sans-serif;
    --monospace-font-family: "Menlo", "dejavu sans mono", "Consolas",
      "Lucida Console", monospace;
    --body-font-size: 12px;
  ...
  .lh-audit__description {
    --inner-audit-left-padding: calc(
      var(--text-indent) + var(--lh-audit-index-width) + 2 * var(--audit-item-gap)
    );
  ...
  .lh-scores-header {
    ...
    overflow-x: hidden;
    position: relative;
    padding: var(--section-indent) calc(var(--section-indent) / 2)
      calc(var(--section-indent) * 2);
  }
  ...
  .lh-scorescale-range::before {
    ...
    height: calc(var(--body-font-size) * 0.6);
    border-radius: 4px;
    display: inline-block;
    margin: 0 5px;
  }
